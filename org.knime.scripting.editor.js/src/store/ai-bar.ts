...
import type { InputOutputModel } from "@knime-scripting-editor/components/InputOutputItem.vue";
import { type UseCodeEditorReturn, useMainCodeEditorStore } from "@knime-scripting-editor/editor";

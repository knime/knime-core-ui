...
class FieldNodeSettingsPersistorTest {
    ...
    void testCreateInstanceWithConfigKey() {
        var persistor = CreateNodeSettingsPersistorUtil.createInstance(CustomPersistorWithConfigKey.class,
            Integer.class, "config_key_parameter");
    ...
    static class CustomPersistorWithConfigKey implements NodeSettingsPersistor<Integer> {

        private final String m_configKey;

        CustomPersistorWithConfigKey(final NodeSettingsPersistorContext<Integer> context) {

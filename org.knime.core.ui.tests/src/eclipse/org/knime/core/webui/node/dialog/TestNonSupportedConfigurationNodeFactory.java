 ...
 */
public class TestNonSupportedConfigurationNodeFactory extends NodeFactory<NodeModel> {

    static class TestConfigNodeModel extends NodeModel
        implements DialogNode<TestNonSupportedConfigNodeRepresentation, TestNonSupportedConfigNodeValue> {
        ...
        @Override
        public void validateDialogValue(final TestNonSupportedConfigNodeValue value) throws InvalidSettingsException {
        }
    ...
    static final class TestNonSupportedConfigNodeValue implements DialogNodeValue {
    ...
    private static final class TestNonSupportedConfigNodeRepresentation implements DialogNodeRepresentation<TestNonSupportedConfigNodeValue> {

        @Override
        public DialogNodePanel<TestNonSupportedConfigNodeValue> createDialogPanel() {
            throw new NotImplementedException("Not implemented");
        }

...
class RendererToJsonFormsUtilTest {
    ...
    static final TextRendererSpec TEST_TEXT_RENDERER = new TextRendererSpec() {
        ...
        @Override
        public Optional<SettingsType> getSettingsType() {
            return Optional.of(SettingsType.VIEW);
        }

        @Override
        public List<String> getPath() {
            return List.of("my", "path");
        }
        ...
        @Override
        public TextRendererOptions getOptions() {

...
class ConfigMappingsTest {
    ...
    static final class Migrator implements DeprecatedSettingsLoadDefinition<Integer> {
    ...
    static final class InferredConfigsFromConfigPathsTestSettings implements PersistableSettings {
        ...
        @BackwardsCompatibleLoader(Migrator.class)
    ...
    void testInferredConfigsFromConfigPaths() {
        ...
        assertThat(firstNonEmptyConfigMappingsChild.m_newAndDeprecatedConfigPaths.getNewConfigPaths())
    ...
    private static void assertDeprecatedConfigPaths(final ConfigMappings configMappings) {
        assertThat(configMappings.m_newAndDeprecatedConfigPaths.getDeprecatedConfigPaths())
    ...
    void testOptionalField() {
        ...
        assertThat(firstNonEmptyConfigMappingsChild.m_newAndDeprecatedConfigPaths.getNewConfigPaths())
            .isEqualTo(List.of(new ConfigPath(List.of("fieldName"))));
        assertThat(firstNonEmptyConfigMappingsChild.m_newAndDeprecatedConfigPaths.getDeprecatedConfigPaths()).isEmpty();
    }

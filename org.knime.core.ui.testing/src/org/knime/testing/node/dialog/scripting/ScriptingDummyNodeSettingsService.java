...
/**
 * TODO move logic back to ScriptingNodeSettingsService where appropriate
 */
public final class ScriptingDummyNodeSettingsService implements NodeSettingsService {
    ...
    private DefaultNodeSettingsService m_settingsDataService;
     ...
     */
    public ScriptingDummyNodeSettingsService( //
        final Supplier<GenericSettingsIOManager> settingsIOManagerSupplier, //
        final GenericInitialDataBuilder initialDataBuilder, final Class<? extends NodeParameters> modelSettings //
    ) {
        ...
        m_settingsDataService =
            new DefaultNodeSettingsService(Map.of(SettingsType.MODEL, m_modelSettings), m_serviceRegistry);
    }
    ...
    public String fromNodeSettings(final Map<SettingsType, NodeAndVariableSettingsRO> settings,
        ...
        try {
            ...
            rootNode.set("additionalSettings",
                MAPPER.readTree(m_settingsDataService.fromNodeSettings(settings, specs)));
    ...
    public void toNodeSettings(final String textSettings,
        ...
        try {
            ...
            m_settingsDataService.toNodeSettings(MAPPER.writeValueAsString(settingsFromText.get("additionalSettings")),

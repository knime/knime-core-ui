...
public final class ScriptingDummyNodeFactory extends NodeFactory<ScriptingDummyNodeModel> implements NodeDialogFactory {
    ...
    @Override
    public ScriptingDummyNodeModel createNodeModel() {
        return new ScriptingDummyNodeModel();
    }
    ...
    @Override
    public NodeView<ScriptingDummyNodeModel> createNodeView(final int viewIndex,
        final ScriptingDummyNodeModel nodeModel) {
        return null;
    }

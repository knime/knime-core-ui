...
describe("useColumnSizes", () => {
  ...
  describe("row height from settings", () => {
    ...
    it("applies default value as minimum for small custom row heights with default padding", () => {
    ...
    it("applies default value as minimum for small custom row heights with compact padding", () => {
      const customRowHeight = 1;
      comp.setRowHeightSettings({
        customRowHeight,
        rowHeightMode: RowHeightMode.CUSTOM,

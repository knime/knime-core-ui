...
public interface TileViewDataService {
    ...
    TileTable getTable(String[] columns, long fromIndex, int numRows, String[] rendererIds, boolean updateDisplayedColumns,
        boolean forceClearImageDataCache, boolean trimColumns, boolean showOnlySelectedRows);

    @SuppressWarnings("java:S107")
    TileTable getFilteredAndSortedTable(String[] columns, long fromIndex, int numRows, String sortColumn,
    ...
    TableViewDataService.HTMLAndCSV getCopyContent(TableViewDataService.SpecialColumnConfig rowIndexConfig,
        TableViewDataService.SpecialColumnConfig rowKeyConfig, boolean withHeaders, String[] dataColumns, int fromIndex,

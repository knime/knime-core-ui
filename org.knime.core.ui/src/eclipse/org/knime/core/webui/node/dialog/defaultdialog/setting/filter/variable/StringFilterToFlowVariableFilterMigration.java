 ...
 */
public class StringFilterToFlowVariableFilterMigration implements NodeSettingsMigration<FlowVariableFilter> {
    ...
    FlowVariableFilter stringFilterSettingsToFlowVariableFilter(final NodeSettingsRO settings)
        ...
        final var stringFilter = SettingsLoaderFactory.loadSettings(StringFilter.class, settings);

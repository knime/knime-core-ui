...
import org.knime.core.webui.node.dialog.defaultdialog.rule.ExpressionCreator.ArrayFieldReference;
import org.knime.core.webui.node.dialog.defaultdialog.rule.ExpressionCreator.BooleanFieldReference;
import org.knime.core.webui.node.dialog.defaultdialog.rule.ExpressionCreator.ColumnFieldSelectionReference;
import org.knime.core.webui.node.dialog.defaultdialog.rule.ExpressionCreator.EnumFieldReference;
import org.knime.core.webui.node.dialog.defaultdialog.rule.ExpressionCreator.StringFieldReference;
...
public sealed class ExpressionCreator<T extends AtomicExpression<T>> permits StringFieldReference, EnumFieldReference,
    BooleanFieldReference, ArrayFieldReference, ColumnFieldSelectionReference {

    final Function<Condition, Expression<T>> m_conditionToExpression;

    ExpressionCreator(final Function<Condition, Expression<T>> conditionToExpression) {
    ...
    public static final class StringFieldReference<T extends AtomicExpression<T>> extends ExpressionCreator<T>
        ...
        @Override
        public Expression isEqualTo(final String value) {
        ...
        @Override
        public Expression matchesPattern(final String pattern) {
        ...
        @Override
        public Expression isNoneString() {
    ...
    public static final class EnumFieldReference<T extends AtomicExpression<T>, E extends Enum<E>>
        extends ExpressionCreator<T> implements EnumReference<E> {
        ...
        @Override
        public Expression isOneOf(@SuppressWarnings("unchecked") final E... values) {
    ...
    public static final class BooleanFieldReference<T extends AtomicExpression<T>> extends ExpressionCreator<T>
    ...
    public static final class ArrayFieldReference<T extends AtomicExpression<T>> extends ExpressionCreator<T>
        ...
        @Override
        public Expression hasMultipleItems() {
            return createExpression(new HasMultipleItemsCondition());
        }

    }

    public static final class ColumnFieldSelectionReference<T extends AtomicExpression<T>> extends ExpressionCreator<T>
        ...
        @Override
        public Expression isNoneColumn() {
            return hasColumnName(SpecialColumns.NONE.getId());
        }

        @Override
        public Expression hasColumnName(final String columnName) {
        ...
        @Override
        public Expression hasColumnType(final Class<? extends DataValue> type) {

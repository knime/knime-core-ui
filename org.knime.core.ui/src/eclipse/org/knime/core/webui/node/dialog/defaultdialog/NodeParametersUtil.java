...
public final class NodeParametersUtil {
    ...
    public static NodeParametersInput createDefaultNodeSettingsContext(final PortObjectSpec[] specs) {
        ...
        return new NodeParametersInputImpl(inPortTypes, specs, nc.getFlowObjectStack(), credentialsProvider, inPortObjects,
            dialogNode);
    }
    ...
    public static void saveSettings(final Class<? extends NodeParameters> settingsClass, final NodeParameters settingsObject,

...
/**
 * A checkbox renderer for a boolean setting.
 *
 * @author Paul Bärnreuther
 */
public interface CheckboxRendererSpec extends ControlRendererSpec {

    @Override
    default Optional<String> getFormat() {
        return Optional.of(UiSchema.Format.CHECKBOX);
    }

 ...
 */
public class StringToStringWithRowIDChoiceMigration extends StringToStringOrEnumMigration<RowIDChoice>
    implements ToStringWithRowIDChoiceMigration {

    /**
     * @param legacyStringKey the key that was previously used to persist the String
     */
    protected StringToStringWithRowIDChoiceMigration(final String legacyStringKey) {

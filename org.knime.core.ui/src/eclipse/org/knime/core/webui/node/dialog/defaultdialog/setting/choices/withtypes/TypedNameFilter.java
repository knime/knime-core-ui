...
/**
 * A class used to store several representation of column choices. I.e. the names can be determined using the same
 * filter options as {@link NameFilter} and an additional option that allows for filtering by a type.
 *
...
public abstract class TypedNameFilter<T extends TypeFilter> implements PersistableSettings {
     ...
     */
    public TypedNameFilter(final String[] initialSelected, final T defaultTypeFilter) {
     ...
     * @param defaultTypeFilter the initial value of the type filter
     */
    public TypedNameFilter(final List<String> initialSelected, final T defaultTypeFilter) {

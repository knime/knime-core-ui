...
public class WidgetTreeFactory extends TreeFactory<WidgetGroup> {
    ...
    private static final Collection<Class<? extends Annotation>> POSSIBLE_TREE_ANNOTATIONS =
        List.of(Layout.class, Effect.class, ValueReference.class, ValueProvider.class, Modification.class,
            Modification.WidgetReference.class);

    private static final Collection<ClassAnnotationSpec> POSSIBLE_TREE_CLASS_ANNOTATIONS =
        List.of(new ClassAnnotationSpec(Layout.class), new ClassAnnotationSpec(Effect.class),
    ...
    private static final Collection<Class<? extends Annotation>> POSSIBLE_LEAF_ANNOTATIONS =
        List.of(Layout.class, Widget.class, NumberInputWidget.class, RadioButtonsWidget.class, ValueSwitchWidget.class,
            ChoicesWidget.class, ComboBoxWidget.class, SortListWidget.class, ButtonWidget.class,
            SimpleButtonWidget.class, DateTimeWidget.class, DateWidget.class, IntervalWidget.class,
    ...
    private static final Collection<Class<? extends Annotation>> POSSIBLE_ARRAY_ANNOTATIONS =
        List.of(Widget.class, ArrayWidget.class, InternalArrayWidget.class, Layout.class, Effect.class,

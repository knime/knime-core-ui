...
public final class DBTableChooserDataService {
    ...
    enum DBItemType {
        ...
        DBItemType nextUp(final boolean supportsCatalogues) {
            return switch (this) {
                ...
                case CATALOG -> ROOT;
                case SCHEMA -> supportsCatalogues ? CATALOG : ROOT;
                case TABLE -> SCHEMA;
            };
        }
    ...
    public boolean supportsCatalogs() throws SQLException {
        return m_adapterInstance.listCatalogs().isPresent();
    }
    ...
    public DBItemType itemType(final List<String> pathParts) throws SQLException {
        boolean supportsCatalogues;
        try {
            supportsCatalogues = supportsCatalogs();
        } catch (SQLException ex) { // NOSONAR don't need to rethrow

 ...
 */
public final class MultiFileSelectionUtil {

    private MultiFileSelectionUtil() {
        // Utility class
    }

    /**
     * Extracts the {@link FileChooserFilters} class from the given node if it is a multi file selection.
     *
     * @param node the node to extract the filters class from
     * @return the filters class if it is a multi file selection, empty otherwise
     */

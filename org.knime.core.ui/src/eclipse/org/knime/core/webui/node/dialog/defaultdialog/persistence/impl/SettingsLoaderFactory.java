...
public final class SettingsLoaderFactory extends AbstractPersistenceFactory<SettingsLoader> {
    ...
    public static <S extends PersistableSettings> S loadSettings(final Class<S> settingsClass,
        ...
        return getSettingsLoader(settingsClass).apply(nodeSettings);
    }
    ...
    private static Object createDefaultSettings(final Tree<PersistableSettings> tree) {

 ...
 */
public final class LegacyNodeSettingsPersistorWrapper<T> implements LegacyNodeSettingsPersistor<T> {
    ...
    public T load(final NodeSettingsRO settings) throws InvalidSettingsException {
        ...
        return m_defaultPersistor.load(this.loadDefaultSettingsFrom(settings));
    }

...
import org.knime.core.webui.node.view.table.data.TileViewDataService;
import org.knime.core.webui.node.view.table.data.TileViewDataServiceImpl;
import org.knime.core.webui.node.view.table.data.TileViewInitialData;
import org.knime.core.webui.node.view.table.data.TileViewInitialDataImpl;
...
public final class TileViewUtil {
     ...
     */
    public static RpcDataService createRpcDataService(final TileViewDataService tableViewDataService,
        final String tableId) {

        Runnable clearCache = () -> TileViewUtil.deactivateTileViewDataService(tableViewDataService, tableId);
     ...
     */
    public static void deactivateTileViewDataService(final TileViewDataService tableViewDataService,
        final String tableId) {
     ...
     */
    public static TileViewDataService createTableViewDataService(final Supplier<BufferedDataTable> tableSupplier,
     ...
     */
    static TileViewInitialData createInitialData(final TileViewViewSettings settings, final BufferedDataTable table,
        final Supplier<Set<RowKey>> selectionSupplier, final String tableId) {
    ...
    public static InitialDataService<TileViewInitialData> createInitialDataService(
        final Supplier<TileViewViewSettings> settingsSupplier, final Supplier<BufferedDataTable> tableSupplier,
        final Supplier<Set<RowKey>> selectionSupplier, final String tableId) {
    ...
    * {@link TileViewDataServiceImpl} so that the RPC data service caches stay in sync with the initial data supplied
    ...
    public static Pair<InitialDataService<TileViewInitialData>, Supplier<RpcDataService>>
        createInitialDataServiceWithRPCDataService(final Supplier<TileViewViewSettings> settingsSupplier,
    ...
    private abstract static class DataServiceCache {
        ...
        TileViewDataService m_dataService;

        abstract TileViewDataService initialize();

        TileViewDataService get() {

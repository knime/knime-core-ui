...
public final class FilterOperatorsExtensionsUtil {
    ...
    private static final String EXT_POINT_ID = "org.knime.core.ui.filterValueParameters";

    private static final Map<DataType, List<FilterOperator>> FILTER_OPERATORS_CORE = Map.ofEntries( //
     ...
     */
    public static Map<DataType, List<FilterOperator>> getCreateDataCellParametersExtensions() {
        ...
        final var extensionProvidedClasses = Stream.of(point.getExtensions()) //
            ...
            .map(FilterOperatorsExtensionsUtil::readCreateDataCellParametersFactory) //
     ...
     */
    public static Class<? extends FilterValueParameters> getFromStringCreateDataCellParametersClass() {
        return null; // TODO
    }

    private static FilterOperatorsFactory readCreateDataCellParametersFactory(final IConfigurationElement cfe) {
        try {

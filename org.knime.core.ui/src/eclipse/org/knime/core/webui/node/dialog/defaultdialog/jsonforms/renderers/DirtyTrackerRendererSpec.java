 ...
 */
public interface DirtyTrackerRendererSpec extends WidgetRendererSpec<DirtyTrackerRendererSpec> {

    @Override
    default Optional<String> getFormat() {
        return Optional.of(JsonFormsConsts.UiSchema.Format.DIRTY_TRACKER);
    }
    ...
    @Override
    default Optional<DirtyTrackerRendererOptions> getOptions() {
     ...
     */
    interface DirtyTrackerRendererOptions {

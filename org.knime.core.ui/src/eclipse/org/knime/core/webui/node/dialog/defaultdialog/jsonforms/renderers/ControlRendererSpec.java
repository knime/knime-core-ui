 ...
 */
public non-sealed interface ControlRendererSpec extends DialogElementRendererSpec {
    ...
    /**
     * Returns the settings type of this control renderer.
     *
     * @return either view or model settings or empty for settings nested in a standalone group (e.g. the element
     *         settings or an array layout)
     */
    Optional<SettingsType> getSettingsType();

    /**
     * @return the path of the settings from its root in the data
     */
    List<String> getPath();

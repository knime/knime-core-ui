 ...
 */
public final class DateTimeStringFormatValidation extends ExternalValidation<String> {

    @Override
    Optional<String> validate(final String currentValue) {
        return DateTimeFormatValidationUtil.validateFormatAndReturnMessage(currentValue, FormatTemporalType.ZONED_DATE_TIME);
    }
}
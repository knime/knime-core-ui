 ...
 */
public final class WidgetTreeToLayoutTree {
    ...
    private static IntermediateState processGroup(final Tree<WidgetGroup> tree) {
        return combineChildren(tree).combineToLeafIfSelfContained(tree.getType());
    }
     ...
     * at every step where a {@link WidgetGroup} is processes, we have to check whether it is "self-contained" (see
     ...
     */
    public abstract static sealed class IntermediateState {
        ...
        public static sealed class LeafState extends IntermediateState {
             ...
             */
            public static final class TraversableLayoutTreeNodeState extends LeafState {
                 ...
                 */
                public TraversableLayoutTreeNode<LeafState> getLayoutTreeNode() {

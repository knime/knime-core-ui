...
import org.knime.core.webui.node.view.table.TileViewViewSettings;
...
public final class TileViewInitialDataImpl implements TileViewInitialData {
    ...
    private final TileViewViewSettings m_settings;
     ...
     */
    public TileViewInitialDataImpl(final TileViewViewSettings settings, final Supplier<BufferedDataTable> table,
    ...
    public TileTable getTable() {
        ...
        return m_dataService.getTable(displayedColumns, 0, m_settings.m_pageSize, new String[displayedColumns.length],
            true, true, false, showOnlySelectedRows);
    }
    ...
    @Override
    public TileViewViewSettings getSettings() {
        return m_settings;
    }
}

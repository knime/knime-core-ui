...
import org.knime.core.webui.node.dialog.defaultdialog.jsonforms.renderers.DirtyTrackerRendererSpec;
import org.knime.node.parameters.updates.StateProvider;

final class DirtyTrackerRenderer implements DirtyTrackerRendererSpec {

    private final DirtyTracker m_annotation;

    DirtyTrackerRenderer(final DirtyTracker annotation) {
        m_annotation = annotation;
    }

    @Override
    public Map<String, Class<? extends StateProvider>> getStateProviderClasses() {
        return Map.of(UiSchema.TAG_MAKE_DIRTY, m_annotation.value());
    }

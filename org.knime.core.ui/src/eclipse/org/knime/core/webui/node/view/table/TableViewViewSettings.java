...
import org.knime.core.webui.node.dialog.defaultdialog.widget.validation.NumberInputWidgetValidation.StaticMinValidation.IsAtLeastOneValidation;
...
public class TableViewViewSettings implements DefaultNodeSettings {
    ...
    @NumberInputWidget(validations = {IsAtLeastOneValidation.class})
    @Migrate(loadDefaultIfAbsent = true)
    @Layout(ViewSection.class)
    ...
    static final class RowHeightMinValidation implements StaticMinValidation {
        @Override
    ...
    static final class RowHeightMaxValidation implements StaticMaxValidation {
        @Override

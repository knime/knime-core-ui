...
public non-sealed interface DataTypeChoicesStateProvider extends ChoicesStateProvider<DataTypeChoice> {
     ...
     */
    default List<DataType> choices(final DefaultNodeSettingsContext context) {
    ...
    @Override
    default List<DataTypeChoice> computeState(final DefaultNodeSettingsContext context) {

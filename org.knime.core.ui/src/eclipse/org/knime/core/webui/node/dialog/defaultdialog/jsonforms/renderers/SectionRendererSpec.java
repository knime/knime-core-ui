...
/**
 * A section with a title that can be used to group other widgets.
 *
 * @author Paul Bärnreuther
 */
public interface SectionRendererSpec extends LayoutRendererSpec {

    @Override
    default String getType() {
        return JsonFormsConsts.UiSchema.TYPE_SECTION;
    }

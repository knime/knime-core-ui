 ...
 * the framework. Since we need to know these config keys for {@link ConfigMappings} to work, we limit ourselves to the
 * case of one known config key.
 *
 * @param <T> the type of the persisted object
 * @author Paul Bärnreuther
 */
public interface FieldNodeSettingsPersistorWithInferredConfigs<T> extends NodeSettingsPersistorWithInferredConfigs<T> {

...
/**
 * Renderer for color previews.
 */
public interface ColorPreviewRendererSpec extends WidgetRendererSpec<ColorPreviewRendererSpec> {

    @Override
    default Optional<String> getFormat() {
        return Optional.of(JsonFormsConsts.UiSchema.Format.COLOR_PREVIEW);
    }

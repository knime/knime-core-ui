...
/**
 * A renderer to display multiple elements in a vertical layout.
 *
 * @author Paul Bärnreuther
 */
public interface VerticalLayoutRendererSpec extends LayoutRendererSpec {

    @Override
    default String getType() {
        return JsonFormsConsts.UiSchema.TYPE_VERTICAL_LAYOUT;
    }

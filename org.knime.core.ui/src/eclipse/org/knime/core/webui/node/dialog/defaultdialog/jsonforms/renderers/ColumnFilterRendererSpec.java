...
/**
 * A column filter renderer spec for a choices setting.
 *
 * @author Robin Gerling
 */
public interface ColumnFilterRendererSpec extends ControlRendererSpec {
    @Override
     ...
     */
    interface ColumnFilterRendererOptions extends TwinlistRendererOptions, ChoicesProviderOptions {

    }

    @Override
    default Optional<ColumnFilterRendererOptions> getOptions() {

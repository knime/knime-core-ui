 ...
 */
public interface SingleSelectListBoxRendererSpec extends ControlRendererSpec {
    ...
    default Optional<String> getFormat() {
        return Optional.of(UiSchema.Format.SINGLE_SELECT_LIST_BOX);
    }

    /**
     * Options for rendering a single select listbox component.
     */
    interface SingleSelectListBoxRendererOptions extends StringChoicesRendererOptions {
    ...
    @Override
    default Optional<SingleSelectListBoxRendererOptions> getOptions() {
        return Optional.empty();
    }
}

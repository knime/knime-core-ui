...
public final class RowHeightPersistorUtil {
    ...
    static final LegacyLoadResult getLoadResultFromLegacyCompactMode(final NodeSettingsRO settings)
        throws InvalidSettingsException {
        return settings.getBoolean(COMPACT_MODE_LEGACY_CONFIG_KEY) ? LEGACY_COMPACT : LEGACY_DEFAULT;
    }

    static final LegacyLoadResult getLoadResultFromLegacyRowHeightMode(final NodeSettingsRO settings)
        throws InvalidSettingsException {
    ...
    static final Predicate<NodeSettingsRO> getFirstTableVersionMatcher() {
    ...
    @FunctionalInterface
    interface LegacyLoadResultExtractor<U> {
        /**
         * @param legacyLoadResult the load result from which to extract a certain property
         * @param settings
         * @return U the type of the property to extract
         * @throws InvalidSettingsException
         */
        U apply(LegacyLoadResult legacyLoadResult, NodeSettingsRO settings) throws InvalidSettingsException;
    }

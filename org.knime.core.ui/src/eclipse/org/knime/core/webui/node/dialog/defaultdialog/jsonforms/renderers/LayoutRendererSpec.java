...
/**
 * The specification of a layout renderer, i.e. a widget that contains other widgets.
 *
...
public interface LayoutRendererSpec extends DialogElementRendererSpec {
    ...
    /**
     * @return the label of the layout if it has one
     */
    ...
    /**
     * @return the description of the layout if it has one
     */

...
public final class DefaultNumberValidationUtil {
     ...
     */
    public static Map<Class<? extends NumberInputWidgetValidation>, NumberInputWidgetValidation>
        ...
        return Map.of( //
            MinValidation.class, new MinValidation() {
                @Override
            ...
            }, MaxValidation.class, new MaxValidation() {
                @Override

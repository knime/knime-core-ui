...
/**
 * Migration from String to StringOrEnum with NoneChoice.
 *
 * @author Paul Bärnreuther
 */
public class StringToStringWithNoneChoiceMigration extends StringToStringOrEnumMigration<NoneChoice>
    implements ToStringWithNoneChoiceMigration {

    /**
     * @param legacyStringKey the key that was previously used to persist the String
     */
    protected StringToStringWithNoneChoiceMigration(final String legacyStringKey) {
        super(legacyStringKey);
    }

...
import org.knime.core.webui.node.dialog.defaultdialog.persistence.impl.AbstractPersistenceFactory.SettingsSaver;
 ...
 */
public class SettingsSaverFactory extends AbstractPersistenceFactory<SettingsSaver> {
    ...
    public static <S extends DefaultNodeSettings> void saveSettings(final S settings,
        final NodeSettingsWO nodeSettings) {
        getSettingsSaver(settings.getClass()).save(settings, nodeSettings);
    }

    public static <S extends PersistableSettings> SettingsSaver getSettingsSaver(final Class<S> settingsClass) {

...
import org.knime.node.parameters.widget.temporal.util.DateTimeFormatValidationUtil;

/**
 * The class used if the settings field uses the type {@link TemporalFormat}.
 */
public final class DateTimeTemporalFormatValidation extends ExternalValidation<TemporalFormat> {

    @Override
    Optional<String> validate(final TemporalFormat currentValue) {
        return DateTimeFormatValidationUtil.validateFormatAndReturnMessage(currentValue.format(), currentValue.temporalType());
    }
}
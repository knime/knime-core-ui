...
final class DateTimePersistorUtils {
    ...
    static final class LocalDatePersistor implements OneKeyNodeSettingsPersistor<LocalDate> {
        ...
        public void save(final LocalDate date, final NodeSettingsWO settings) {
            settings.addString(m_configKey, date.format(DATE_FMT));
        }
    ...
    static final class LocalTimePersistor implements OneKeyNodeSettingsPersistor<LocalTime> {
        ...
        public void save(final LocalTime obj, final NodeSettingsWO settings) {
            ...
            settings.addString(m_configKey, timeToSave);
        }
    ...
    static final class TimeZonePersistor implements OneKeyNodeSettingsPersistor<ZoneId> {
        ...
        public ZoneId load(final NodeSettingsRO settings) throws InvalidSettingsException {
            if (settings.getString(m_configKey) == null) {
                return null;
            } else {
                return TimeZonePersistor.extractFromString(settings.getString(m_configKey));
            }
        }
        ...
        public void save(final ZoneId obj, final NodeSettingsWO settings) {
            if (obj != null) {
                settings.addString(m_configKey, obj.getId());
            } else {

...
public abstract class ColumnSelectionToStringOrEnumMigration<E extends Enum<E>>
    ...
    private StringOrEnum<E> loadFromStringOrColumnSelection(final NodeSettingsRO settings)
        ...
        final var oldString = ColumnSelectionToStringMigration.loadFromStringOrColumnSelection(
            m_legacyColumnSelectionConfigKey, m_legacyStringOrColumnSelectionConfigKey, settings);

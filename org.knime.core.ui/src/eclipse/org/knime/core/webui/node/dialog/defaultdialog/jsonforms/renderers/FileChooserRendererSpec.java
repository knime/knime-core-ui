 ...
 * Corresponds to the FileSelectionOptions TypeScript type.
 *
 * @author Paul Bärnreuther
 */
public interface FileChooserRendererSpec extends ControlRendererSpec {
    ...
    default Optional<String> getFormat() {
        return Optional.of(UiSchema.Format.FILE_CHOOSER);
    }

    @Override
    default Optional<FileChooserRendererOptions.FileChooserOptions> getOptions() {

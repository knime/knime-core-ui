 ...
 * @param stateProviderSupplier a supplier that creates the {@link StateProvider} when needed
 */
@SuppressWarnings("rawtypes")
public record ResolvedStateProvider(Object identifier, Supplier<StateProvider> stateProviderSupplier) {

    ResolvedStateProvider(final Class<? extends StateProvider> stateProviderClass) {
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof final ResolvedStateProvider other)) {
            return false;
        }

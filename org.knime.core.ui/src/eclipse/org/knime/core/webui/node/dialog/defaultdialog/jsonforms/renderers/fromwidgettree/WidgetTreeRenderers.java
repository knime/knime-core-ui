...
public class WidgetTreeRenderers {
    ...
    static final WidgetTreeNodeTester[] PRIMARY_TESTERS = new WidgetTreeNodeTester[]{//
    };

    static final WidgetTreeNodeTester[] FALLBACK_TESTERS = new WidgetTreeNodeTester[]{//
        ...
        new WidgetTreeNodeTester(IntegerRenderer::new,
            node -> Integer.class.equals(ClassUtils.primitiveToWrapper(node.getRawClass()))), //
        new WidgetTreeNodeTester(NumberRenderer::new,
            node -> Number.class.isAssignableFrom(ClassUtils.primitiveToWrapper(node.getRawClass()))), //
    ...
    public static ControlRendererSpec getRendererSpec(final TreeNode<WidgetGroup> node) {
        return Stream.concat(//
            Stream.of(PRIMARY_TESTERS), //
            Stream.of(FALLBACK_TESTERS) //
        ).filter(tester -> tester.tester().test(node))//
            .findFirst()//

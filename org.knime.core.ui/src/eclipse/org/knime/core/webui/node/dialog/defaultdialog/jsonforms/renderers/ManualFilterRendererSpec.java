 ...
 */
public interface ManualFilterRendererSpec extends ControlRendererSpec {
    @Override
    ...
    default Optional<String> getFormat() {
        return Optional.of(UiSchema.Format.MANUAL_TWINLIST);
    }

    /**
     * Options for rendering a manual filter component.
     */
    interface ManualFilterRendererOptions extends TwinlistRendererOptions, StringChoicesRendererOptions {
    }

    @Override
    default Optional<ManualFilterRendererOptions> getOptions() {

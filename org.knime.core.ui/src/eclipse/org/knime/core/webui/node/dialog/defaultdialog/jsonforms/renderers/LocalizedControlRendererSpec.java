 ...
 */
public non-sealed interface LocalizedControlRendererSpec extends DialogElementRendererSpec {

    /**
     * Overwrite this method if the renderer is to be used on a nested JSON object.
     *
     ...
     */
    ControlRendererSpec getControlSpec();
     ...
     */
    default LocalizedControlRendererSpec at(final String... path) {
        ...
        final var rendererSpec = getControlSpec();
        return new LocalizedControlRendererSpec() {
            @Override
            ...
            @Override
            public ControlRendererSpec getControlSpec() {
                return rendererSpec;
            }
        };
    }

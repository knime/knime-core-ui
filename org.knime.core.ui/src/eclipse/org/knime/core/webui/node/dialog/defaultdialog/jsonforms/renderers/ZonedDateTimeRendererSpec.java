 ...
 */
public interface ZonedDateTimeRendererSpec extends ControlRendererSpec {
    ...
    default Optional<String> getFormat() {
        return Optional.of(UiSchema.Format.ZONED_DATE_TIME);
    }

    /**
     * Options for rendering a zoned date&time field.
     */
    interface ZonedDateTimeRendererOptions extends TimeRendererOptions {
    ...
    @Override
    default Optional<ZonedDateTimeRendererOptions> getOptions() {
        return Optional.empty();
    }
}

...
/**
 * Renderer to input a text value in a text area.
 *
 * @author Paul Bärnreuther
 */
public interface TextAreaRendererSpec extends ControlRendererSpec {

    @Override
    default Optional<TextAreaRendererOptions> getOptions() {
     ...
     */
    interface TextAreaRendererOptions {

        /**
         * @return the number of rows to show in the text area
         */
        int getRows();
    ...
    default Optional<String> getFormat() {
        return Optional.of(UiSchema.Format.TEXT_AREA);
    }

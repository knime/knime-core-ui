 ...
 *
 * History
 *   18 Sept 2025 (Manuel Hotz, KNIME GmbH, Konstanz, Germany): created
 */
...
public interface FilterOperatorProvider {
    ...
    /**
     * Gets the operator for the given type and ID, or an empty optional if no such operator exists.
     *
     * @param type the data type
    ...
    /**
     * Gets the default operator for the given type, or an empty optional if no such operator exists. The default
     * operator could be used to pre-select an operator in the UI.
     *
     * @param type the data type

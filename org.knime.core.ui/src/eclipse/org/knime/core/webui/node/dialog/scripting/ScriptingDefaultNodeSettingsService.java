...
public final class ScriptingDefaultNodeSettingsService implements NodeSettingsService {
    ...
    public ScriptingDefaultNodeSettingsService( //
        ...
        m_settingsDataService =
            new DefaultNodeSettingsService(Map.of(SettingsType.MODEL, m_modelSettings), serviceRegistry);
    }
    ...
    public String fromNodeSettings(final Map<SettingsType, NodeAndVariableSettingsRO> settings,
        ...
        try {
            ...
            // Note that settingsInitialData is a String containing a JSON object which is then parsed in the frontend
            rootNode.put("settingsInitialData", m_settingsDataService.fromNodeSettings(settings, specs));
    ...
    public void toNodeSettings(final String textSettings,
        ...
        m_settingsDataService.toNodeSettings(textSettings, previousSettings, settings);
    }
}

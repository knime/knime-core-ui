...
/**
 * A renderer for a local date&time.
 *
 * @author Robin Gerling
 */
public interface LocalDateTimeRendererSpec extends ControlRendererSpec {
    ...
    default Optional<String> getFormat() {
        return Optional.of(UiSchema.Format.LOCAL_DATE_TIME);
    }

    /**
     * Options for rendering a local date&time field.
     */
    interface LocalDateTimeRendererOptions extends TimeRendererOptions {
    }

    @Override
    default Optional<LocalDateTimeRendererOptions> getOptions() {

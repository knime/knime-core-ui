...
public final class WidgetImplementationUtil {
    ...
    private static final WidgetAnnotation[] WIDGET_ANNOTATIONS = new WidgetAnnotation[]{//
        ...
        new WidgetAnnotation(List.of(FileSelection.class, MultiFileSelection.class, LegacyMultiFileSelection.class), FileReaderWidget.class), //
    ...
    private static final DefaultWidget[] DEFAULT_WIDGETS = new DefaultWidget[]{//
        ...
        new DefaultWidget(List.of(MultiFileSelection.class, LegacyMultiFileSelection.class), DefaultWidgetType.MULTI_FILE_CHOOSER), //

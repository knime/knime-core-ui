 ...
 */
package org.knime.node.parameters.widget.message;
...
public @interface TextMessage {
    ...
    interface SimpleTextMessageProvider extends StateProvider<Optional<TextMessage.Message>> {
         ...
         */
        boolean showMessage(NodeParametersInput context);
        ...
        @Override
        default Optional<Message> computeState(final NodeParametersInput context) {
    ...
    interface InputPreviewMessageProvider extends StateProvider<Optional<TextMessage.Message>> {
         ...
         * @return the description of the message
         */
        default String description(final NodeParametersInput context) {

...
/**
 * A class that provides an array of possible column choices based on the current {@link NodeParametersInput}.
 *
...
public interface FlowVariableChoicesProvider extends TypedStringChoicesProvider {
    ...
    /**
     * Computes the array of possible column choices based on the {@link NodeParametersInput}.
     *
     ...
     */
    default List<FlowVariable> flowVariableChoices(final NodeParametersInput context) {
    ...
    @Override
    default List<TypedStringChoice> computeState(final NodeParametersInput context) {

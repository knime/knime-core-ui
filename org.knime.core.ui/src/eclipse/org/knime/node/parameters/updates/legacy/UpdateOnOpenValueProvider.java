 ...
 */
public abstract class UpdateOnOpenValueProvider<S> implements StateProvider<S>, ParameterReference<S> {
    ...
    public void init(final StateProviderInitializer initializer) {
        ...
        final var type = (Class<? extends ParameterReference<S>>)this.getClass();
        m_currentValueSupplier = initializer.getValueSupplier(type);
    }

    @Override
    public S computeState(final NodeParametersInput parametersInput) {

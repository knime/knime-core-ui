...
public interface PredicateProvider {
     ...
     * the {@link NodeParametersInput} or on another {@link PredicateProvider}.
     *
     * @param i
     ...
     * {@link NodeParametersInput} or another {@link PredicateProvider}
     *
    ...
    interface PredicateInitializer {
         ...
         */
        Predicate getConstant(java.util.function.Predicate<NodeParametersInput> predicate);

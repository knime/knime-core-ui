...
public interface StateProvider<S> {
    ...
    interface StateProviderInitializer {
         ...
         */
        NodeParametersInput getNodeParametersInput();
         ...
         */
        <T> Supplier<T> computeFromValueSupplier(Class<? extends ParameterReference<T>> ref);
         ...
         */
        <T> Supplier<T> getValueSupplier(Class<? extends ParameterReference<T>> ref);
         ...
         * @return a supplier to be used during {@link #computeState}.
         */
        default <T> Supplier<T> getValueSupplier(final Class<? extends ParameterReference<?>> ref,
         ...
         * @param <T> the type of the dependency
         */
        <T> void computeOnValueChange(Class<? extends ParameterReference<T>> id);

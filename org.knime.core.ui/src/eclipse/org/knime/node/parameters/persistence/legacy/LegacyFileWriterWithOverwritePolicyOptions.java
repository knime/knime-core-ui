...
/**
 *
 * Parameters that are backwards-compatible to a {@link DialogComponentWriterFileChooser} that has overwrite policy
 * options.
 *
 * @author Thomas Reifenberger
 */
public class LegacyFileWriterWithOverwritePolicyOptions extends LegacyFileWriter {

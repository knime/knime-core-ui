...
public class LegacyFileWriterWithOverwritePolicyOptions extends LegacyFileWriterWithCreateMissingFolders {
    ...
    private static final String DOC_HEADER =
        "Specify the the behavior of the node in case the output file already exists." + "<ul>";
     ...
     * @author Thomas Reifenberger
     */
    public static abstract class OverwritePolicyChoicesProvider implements EnumChoicesProvider<OverwritePolicy> {

...
/**
 * Fluent API to create/compose a node as required by the {@link DefaultNodeFactory}.
 *
 * The node requires a name, an icon, a short description, a full description, {@link PortsAdder ports} or
 * {@link DynamicPortsAdder dynamic ports} (in case the node is {@link ConfigurableNodeFactory configurable}), and a
 * {@link DefaultModel model}. Optionally, it can also have a {@link DefaultView view}, a {@link NodeType type},
 * keywords, a version, and external resources.
 *
 * <br>
 *
...
public final class DefaultNode implements FluentNodeAPI {
    ...
    public interface RequireIcon { // NOSONAR
        /**
         * Specifies the icon of the node.
         *
    ...
    public interface RequireShortDescription { // NOSONAR
        /**
         * Specifies the short description of the node.
         *
    ...
    public interface RequireFullDescription { // NOSONAR
        /**
         * Specifies the full description of the node.
         *
    ...
    /**
     * The build stage that requires the model.
     */
    public interface RequireModel { // NOSONAR
        /**
         * Specifies the model of the node.
         *
    ...
    /**
     * Adds a view to the node. A view is a visual representation of the node, e.g., a table view or a plot. Currently,
     ...
     */
    public DefaultNode addView(final Function<RequireViewParameters, DefaultView> view) {
        if (m_view != null) {
    ...
    /**
     * Adds a list of keywords that are used for searching nodes. The list itself is not visible to the user.
     *
    ...
    public DefaultNode keywords(final String... keywords) {
        if (!m_keywords.isEmpty()) {
            throw new IllegalStateException(
                "keywords() has already been called; a node can only have one list of keywords.");
        }

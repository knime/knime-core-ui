...
public abstract sealed class DefaultModel implements FluentNodeAPI {
    ...
    public interface ConfigureOrRearrangerConsumer<I, O> {
         ...
         * @throws InvalidSettingsException if some settings are invalid and the node cannot be configured or columns
         *             cannot be arranged
         */
     ...
     * provides access to the input specs.
     */
    public interface ConfigureInput {

        /**
         * Returns the model settings of the node.
         *
         ...
         *
         * @param <S> the type of the input specifications ({@link PortObjectSpec} in case of mixed types)
     ...
     * This interface is used within the
     * {@link RequireConfigureOrRearrangeColumns#configure(ConfigureOrRearrangerConsumer)} phase of a node model and
     * provides methods to define output specs and access settings.
     */
     ...
     * provides access to the settings, input data, and execution context.
     */
    public interface ExecuteInput {
         ...
         *
         * @param <D> the type of the input data ({@link PortObject} in case of mixed types)
     ...
     * and provides access to the current settings, the input data table spec, and an {@link ColumnRearranger}.
     */

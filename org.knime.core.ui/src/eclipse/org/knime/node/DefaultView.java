...
public final class DefaultView implements FluentNodeAPI {
    ...
    public interface RequireViewSettings {
        ...
        /**
         * Specifies the view settings class of the node.
         *
     ...
     * {@link DefaultView#dataService(Function)} and provides access to the settings and internal data.
     */
    public interface ViewInput {

        /**
         * Returns the settings of the node view.
         *
